...
function WebZui(logfunc) {
	  var widthInChars = gIsIphone ? 38 : 101;
	  ...
	  var methods = {
	    ...
	    _scrollBottomWindow: function() {
	      ...
	      if (!gIsIphone) {
	        ...
	        self._scrollGOQWindow();
	      }
	    },

			_scrollGOQWindow: function() {
				var goqhgt = $("#goq-window").attr("scrollHeight");	
				$("#goq-window").attr({ scrollTop: goqhgt + 1000 });
			},
...
$(document).ready(function() {
  ...
  var story = qs.get("story", "stories/geoquest.js");
